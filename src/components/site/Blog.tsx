...
const articlesEn: Article[] = [
  {
    ...
    body: [
      "If you've never taken a dance class in your life, you're exactly who we teach. River City Dance Studio has welcomed absolute beginners on San Antonio's West Side for over 45 years, and our beginner public classes every Friday at 7:00 PM are designed for people starting from zero.",
  ...
  },
  {
    ...
    body: [
      ...
      "Why dancing works so well for older adults: it's low-impact but genuinely aerobic, it trains balance and coordination (key for fall prevention), and learning steps is a proven workout for the brain. Just as important, it's social. Our Friday 7:00 PM beginner classes feel more like a family gathering than a fitness class.",
      ...
      "Getting started is simple: drop in any Friday at 7:00 PM for a $25 beginner class, or pick up the $145 Starter Bundle — 10 beginner classes you can share with up to 2 people, with a 24-hour cancellation credit and a bring-a-friend-free pass. Many of our senior students also love private lessons ($100 single / $150 couple) to build confidence at their own pace before joining the group.",
...
const articlesEs: Article[] = [
  {
    ...
    body: [
      "Si nunca has tomado una clase de baile, eres exactamente a quien enseñamos. River City Dance Studio ha recibido principiantes absolutos en el West Side de San Antonio por más de 45 años, y nuestras clases públicas para principiantes cada viernes a las 7:00 PM están diseñadas para quienes empiezan desde cero.",
  ...
  },
  {
    ...
    body: [
      ...
      "Por qué el baile funciona tan bien para adultos mayores: es de bajo impacto pero verdaderamente aeróbico, entrena el equilibrio y la coordinación (clave para prevenir caídas), y aprender pasos es un ejercicio comprobado para el cerebro. Igual de importante, es social. Nuestras clases de los viernes a las 7:00 PM se sienten más como una reunión familiar que como una clase de ejercicio.",
  ...
  },
  {
    ...
    body: [
      ...
      "También encontrarás salón latino y Swing en nuestra pista, enseñados por los instructores bilingües Chi y Cristine Diaz. Nuestras clases públicas para principiantes son cada viernes a las 7:00 PM en 3534 Fredericksburg Rd #24 — $25 por clase, sin pareja necesaria. El Paquete Inicial de $145 (10 clases, compartible con hasta 2 personas) es la mejor manera de aprenderlos todos, y las lecciones privadas ($100 individual / $150 pareja) te permiten enfocarte en tu estilo favorito.",
