          ...
          {rows.map((r) => (
            ...
            >
              ...
              <a
                ...
                className="md:justify-self-end col-span-2 md:col-span-1 inline-flex justify-center text-xs font-semibold uppercase tracking-widest border border-parchment/20 px-5 py-3 rounded-full hover:bg-parchment hover:text-ink transition-colors"
              >
                {t("schedule_reserve")}
              </a>
            </div>
