...
const en: Dict = {
  ...
  hero_pill: "Beginner Public Classes: Fri @ 7:00 PM",
  ...
  schedule_sub: "Drop in any Friday. No partner required.",
...
const es: Dict = {
  ...
  hero_pill: "Clases públicas para principiantes: Vie a las 7:00 PM",
  ...
  schedule_sub: "Ven cualquier viernes. No necesitas pareja.",
